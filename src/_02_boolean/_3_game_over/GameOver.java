...
public class GameOver {
	...
	public static void main(String[] args) {
		...
		while(gameOver!=true){	// 1. Ask the user if the game is over and save their answer.
		String meow =JOptionPane.showInputDialog("is the game over");
		// 2. If they answer "yes" change gameOver to true.
		if(meow.contains("yes")) 
		{
		gameOver= true;			
	}}
